            ...
            <div class="row reg-banner-margin">
                ...
                <div class="col-12 col-md-3 p-0 pt-3">
                    <div class="card m-3">
                        ...
                        <div class="card-body">
                            <div v-for="item in calenMenu" class="btn-tran">
                                <div style="display:flex">
                                    <a v-bind:href="item.url" class="btn btn-tran text-left mb-2 side-df"
                                        v-on:click="getiContent($event, item.target)">
                                        <i class="icofont-caret-right text-primary" style="margin:auto;"></i>
                                        <span class="side-text">{{ t(item.yearEN, item.yearTH) }}</span>
                                    </a>
                                    <div style="display:flex;flex-direction: column;">
                                        <a v-bind:href="item.url" class="btn btn-tran text-left mb-2 side-df"
                                            v-on:click="getiContent($event, item.underGraduate)">
                                            <span class="side-text" style="color:#f58965;">{{ t("Undergraduate", "ปริญญาตรี") }}</span>
                                        </a>
                                        <a v-bind:href="item.url" class="btn btn-tran text-left mb-2 side-df"
                                            v-on:click="getiContent($event, item.graduate)">
                                            <span class="side-text" style="color:#16c506;">{{ t("Graduate", "บัณฑิตศึกษา") }}</span>
                                        </a>
                                    </div>
                                </div>
                                <hr  class="m-0">
                ...
                <div class="col-12 col-md-9 p-0">
                    <iframe frameborder="0" allowtransparency="yes" marginheight="0" marginwidth="0" width="100%"
                        id="iContent" scrolling="yes" src="_index.php" style="min-height: 100vh;"
                        ></iframe>
                </div>
            </div>
            <!-- ---------------------------------------------------------- -->
