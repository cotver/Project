...
<head>
    ...
    <title>การรับบุคคลเข้าศึกษาต่อ สจล. | KMITL Admissions |</title>
</head>
...
<body>
        ...
        <div class="container-xl reg-page">
            ...
            <div class="row reg-banner-margin shadow-sm bg-white pb-3">
                <div class="col-12 p-0">
                    <div class="col-12 pt-4 pl-5 mb-5 mt-5 con-center">
                        <span class="h3 font-weight-bold linear-wipes text-dark">
                            {{ t('Candidate Admission', 'การรับบุคคลเพื่อเข้าศึกษาต่อ') }}
                        </span>
                    </div>
                    <div class="ml-5 mr-5 mb-5 side-df p-5">
                        <a href="https://new.reg.kmitl.ac.th/admission/" class="btn btn-lightgrey text-left side-df m-auto">
                            ...
                            <span class="h4 pl-2 m-auto p-sm-3"><p>ระดับปริญญาตรี</p><p class="mb-0">Undergraduate</p></span>
                        </a>
                        <a href="https://new.reg.kmitl.ac.th/admission/" class="btn btn-lightgrey text-left side-df m-auto">
                            <i class="icofont-circled-right text-primary h5 m-auto"></i>
    ...
    <script type="text/javascript">
        ...
        (function titleScroller(text) {
            ...
            }(" การรับบุคคลเข้าศึกษาต่อ สจล. | KMITL Admissions |  "));
    </script>
</body>
